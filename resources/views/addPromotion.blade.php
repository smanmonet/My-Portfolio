                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <div class="input-group has-validation">
                                        <input type="text" class="form-control" id="PromotionID" name="PromotionID" value="<?php echo rand(100000,999999); ?>" placeholder="" required="" readonly>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <label for="username" class="form-label">ชื่อโปรโมชั่น</label>
                                    <div class="input-group has-validation">
                                        <input type="text" class="form-control" id="PromotionName" name="PromotionName" value="" placeholder="Promotion Name" required="">
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group has-validation">
                                        <input type="text" class="form-control" name = "Price" value="" id="Price" placeholder="Price" required="">
                                    </div>
                                    @error('Price')
                                        <div class="my-2"> 
                                            <span class="text text-danger">{{$message}}</span>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group has-validation">
                                        <input type="text" class="form-control" name = "PV" value="" id="PV" placeholder="Promotion PV" required="">
                                    </div>
                                    @error('PV')
                                        <div class="my-2"> 
                                            <span class="text text-danger">{{$message}}</span>
                                                    ...
                                                    <div class="card-body .bg-light">
                                                        <p class="card-text">
                                                            ...
                                                            <div class="form-check">
                                                                <input type="checkbox" class="form-check-input" id="{{$item->productname}}" name="product[]" value="{{$item->productname}}|{{$item->productID}}">
