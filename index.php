...
<body>
    <div class="headnav">
        ...
        <div>
            <a href="#" id="myDairyLink" onclick="checkLogin()">My Diary</a>
...
<form method="post" action="">
    ...
    <script>
        function checkLogin() {
            // สมมุติว่ามีการตรวจสอบสถานะการล็อกอินที่นี่
            // หากผู้ใช้ยังไม่ได้ล็อกอิน
            const loggedIn = false; // เปลี่ยนเป็น true ถ้าผู้ใช้ล็อกอินแล้ว
            if (!loggedIn) {
                alert("Please login");
                // ถ้าต้องการเปลี่ยนเส้นทางไปยังหน้า login:
                // window.location.href = "home.php";
            } else {
                // ถ้าผู้ใช้ล็อกอินแล้ว ให้ไปยังหน้า My Dairy
                window.location.href = "my_dairy.php"; // เปลี่ยนเป็น URL ของหน้าที่ต้องการไป
            }
        }
    </script>
</body>
